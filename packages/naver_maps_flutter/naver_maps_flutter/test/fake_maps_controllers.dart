...
class FakePlatformNaverMap {
  FakePlatformNaverMap(int id, Map<dynamic, dynamic> params)
      : cameraPosition =
...
class FakePlatformViewsController {
  FakePlatformNaverMap? lastCreatedView;
  ...
  Future<dynamic> fakePlatformViewsMethodHandler(MethodCall call) {
    switch (call.method) {
      case 'create':
        ...
        lastCreatedView = FakePlatformNaverMap(
          args['id'],
          params,
        );
