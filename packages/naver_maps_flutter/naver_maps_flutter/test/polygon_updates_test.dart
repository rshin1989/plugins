...
void main() {
  ...
  testWidgets('Initializing a polygon', (WidgetTester tester) async {
    ...
    expect(platformNaverMap.polygonsToAdd.length, 1);

    final Polygon initializedPolygon = platformNaverMap.polygonsToAdd.first;
    expect(initializedPolygon, equals(p1));
    expect(platformNaverMap.polygonIdsToRemove.isEmpty, true);
    expect(platformNaverMap.polygonsToChange.isEmpty, true);
  });
  ...
  testWidgets("Adding a polygon", (WidgetTester tester) async {
    ...
    final Polygon addedPolygon = platformNaverMap.polygonsToAdd.first;
  ...
  testWidgets("Removing a polygon", (WidgetTester tester) async {
    ...
    final FakePlatformNaverMap platformNaverMap =
        fakePlatformViewsController.lastCreatedView!;
    expect(platformNaverMap.polygonIdsToRemove.length, 1);
    expect(platformNaverMap.polygonIdsToRemove.first, equals(p1.polygonId));

    expect(platformNaverMap.polygonsToChange.isEmpty, true);
    expect(platformNaverMap.polygonsToAdd.isEmpty, true);
  });
  ...
  testWidgets("Updating a polygon", (WidgetTester tester) async {
    ...
    final FakePlatformNaverMap platformNaverMap =
        fakePlatformViewsController.lastCreatedView!;
    expect(platformNaverMap.polygonsToChange.length, 1);
    expect(platformNaverMap.polygonsToChange.first, equals(p2));
  ...
  testWidgets("Mutate a polygon", (WidgetTester tester) async {
    ...
    final FakePlatformNaverMap platformNaverMap =
        fakePlatformViewsController.lastCreatedView!;
    expect(platformNaverMap.polygonsToChange.length, 1);
    expect(platformNaverMap.polygonsToChange.first, equals(p1));
  ...
  testWidgets("Multi Update", (WidgetTester tester) async {
    ...
    expect(platformNaverMap.polygonsToChange, cur);
    expect(platformNaverMap.polygonIdsToRemove.isEmpty, true);
    expect(platformNaverMap.polygonsToAdd.isEmpty, true);
  });
  ...
  testWidgets("Multi Update", (WidgetTester tester) async {
    ...
    expect(platformNaverMap.polygonsToChange.first, equals(p2));
    expect(platformNaverMap.polygonsToAdd.first, equals(p1));
    expect(platformNaverMap.polygonIdsToRemove.first, equals(p3.polygonId));
  });
  ...
  testWidgets("Partial Update", (WidgetTester tester) async {
    ...
    expect(platformNaverMap.polygonsToChange, <Polygon>{p3});
    expect(platformNaverMap.polygonIdsToRemove.isEmpty, true);
    expect(platformNaverMap.polygonsToAdd.isEmpty, true);
  });
