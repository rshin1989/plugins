...
void main() {
  ...
  late TestNaverMapsFlutterPlatform platform;

  setUp(() {
    // Use a mock platform so we never need to hit the MethodChannel code.
    platform = TestNaverMapsFlutterPlatform();
...
class TestNaverMapsFlutterPlatform extends NaverMapsFlutterPlatform {
  TestNaverMapsFlutterPlatform();
