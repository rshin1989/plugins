...
/// A widget which displays a map with data obtained from the Naver Maps service.
class NaverMap extends StatefulWidget {
  /// Creates a widget displaying data from Naver Maps services.
  ///
...
class _NaverMapState extends State<NaverMap> {
  ...
  Widget build(BuildContext context) {
    return NaverMapsFlutterPlatform.instance.buildView(
      _mapId,
...
class _NaverMapOptions {
  _NaverMapOptions.fromWidget(NaverMap map)
