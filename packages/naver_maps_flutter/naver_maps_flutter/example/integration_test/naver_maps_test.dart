...
import 'naver_map_inspector.dart';
...
void main() {
  ...
  testWidgets('testCompassToggle', (WidgetTester tester) async {
    ...
    final Completer<NaverMapInspector> inspectorCompleter =
        Completer<NaverMapInspector>();
    await tester.pumpWidget(Directionality(
      ...
      child: NaverMap(
        ...
        onMapCreated: (NaverMapController controller) {
          final NaverMapInspector inspector =
              // ignore: invalid_use_of_visible_for_testing_member
              NaverMapInspector(controller.channel);
          inspectorCompleter.complete(inspector);
        },
      ),
    ));

    final NaverMapInspector inspector = await inspectorCompleter.future;
  ...
  testWidgets('updateMinMaxZoomLevels', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(Directionality(
      ...
      child: NaverMap(
        ...
        onMapCreated: (NaverMapController c) async {
          final NaverMapInspector inspector =
              // ignore: invalid_use_of_visible_for_testing_member
              NaverMapInspector(c.channel);
          controller = c;
          inspectorCompleter.complete(inspector);
        },
      ),
  ...
  testWidgets('testInitialCenterLocationAtCenter', (WidgetTester tester) async {
    ...
    if (Platform.isIOS) {
      // On iOS, the coordinate value from the NaverMapSdk doesn't include the devicePixelRatio`.
  ...
  testWidgets('testSetMapStyle valid Json String', (WidgetTester tester) async {
    final Key key = GlobalKey();
    final Completer<NaverMapController> controllerCompleter =
        Completer<NaverMapController>();
    ...
    final NaverMapController controller = await controllerCompleter.future;
  ...
  testWidgets('testToggleInfoWindow', (WidgetTester tester) async {
    ...
    Completer<NaverMapController> controllerCompleter =
        Completer<NaverMapController>();
    ...
    NaverMapController controller = await controllerCompleter.future;
  ...
  testWidgets('testTakeSnapshot', (WidgetTester tester) async {
    Completer<NaverMapInspector> inspectorCompleter =
        Completer<NaverMapInspector>();
