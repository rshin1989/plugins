...
/// The interface that platform-specific implementations of `naver_maps_flutter` must extend.
///
...
///
/// Do `extends NaverMapsFlutterPlatform` instead, so new methods added here are
...
abstract class NaverMapsFlutterPlatform extends PlatformInterface {
  ...
  /// class that extends [NaverMapsFlutterPlatform] when they register themselves.
