...
/// An implementation of [NaverMapsFlutterPlatform] that uses [MethodChannel] to communicate with the native code.
///
/// The `naver_maps_flutter` plugin code itself never talks to the native code directly. It delegates
/// all those calls to an instance of a class that extends the NaverMapsFlutterPlatform.
///
...
class MethodChannelNaverMapsFlutter extends NaverMapsFlutterPlatform {
  ...
  Widget buildView(
    ...
    if (defaultTargetPlatform == TargetPlatform.android) {
      return AndroidView(
        viewType: 'plugins.flutter.io/naver_maps',
