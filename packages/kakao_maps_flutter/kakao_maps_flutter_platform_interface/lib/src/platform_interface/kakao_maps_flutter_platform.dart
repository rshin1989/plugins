...
abstract class KakaoMapsFlutterPlatform extends PlatformInterface {
  ...
  /// cleared from the map after calling this method. The Kakao Maps SDK maintains a small
  ...
  ///
  /// The style string can be generated using [map style tool](https://mapstyle.withkakao.com/).
