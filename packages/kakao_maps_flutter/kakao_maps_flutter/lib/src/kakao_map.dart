...
class _KakaoMapState extends State<KakaoMap> {
  ...
  late _KakaoMapOptions _naverMapOptions;

  @override
  Widget build(BuildContext context) {
    return KakaoMapsFlutterPlatform.instance.buildView(
      _mapId,
      ...
      mapOptions: _naverMapOptions.toMap(),
    );
  }
  ...
  void initState() {
    super.initState();
    _naverMapOptions = _KakaoMapOptions.fromWidget(widget);
  ...
  void dispose() async {
    super.dispose();
    KakaoMapController controller = await _controller.future;
    controller.dispose();
  }
...
class _KakaoMapOptions {
  _KakaoMapOptions.fromWidget(KakaoMap map)
